...
$MenuPageSize = 20  # Long pick-lists (e.g. the base-template picker) show this many rows per page
...
function Read-PagedMenuChoice
{
    ...
    while ($true)
    {
        ...
        if ($hasNext)
        {
            $navParts.Add('Enter or N for the next 20')
        }

        if ($hasPrev)
        {
            $navParts.Add('P for the previous 20')
        }
