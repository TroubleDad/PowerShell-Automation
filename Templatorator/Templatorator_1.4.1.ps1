...
#               forest), and network access to smtp.uhhs.com:25.
#
# Change Log:#
...
function Get-ConfigNamingContext
{
    ...
    $rootDse  = New-Object System.DirectoryServices.DirectoryEntry (Get-RootDsePath)
...
function Get-BaseTemplateEntry
{
    ...
    $searchRoot = New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $TemplatesDN)
...
function New-TemplateCertificateOid
{
    ...
    for ($attempt = 0; $attempt -lt 20; $attempt++)
    {
        ...
        $checkRoot = New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $OidDN)
...
function New-TemplateOidObject
{
    ...
    $container = New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $OidDN)
...
function New-CertificateTemplateFromBase
{
    ...
    $container = New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $containers.TemplatesDN)
...
function Select-BaseTemplate
{
    ...
    $searchRoot = New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $containers.TemplatesDN)
...
function Get-AttributeSchemaGuid
{
    ...
    $searcher             = New-Object System.DirectoryServices.DirectorySearcher
    $searcher.SearchRoot  = New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $schemaNc)
    $searcher.SearchScope = 'OneLevel'
...
function Get-EnrollmentServiceEntry
{
    ...
    $searchRoot = New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $esContainer)
...
function Get-TemplateEntryByCn
{
    ...
    return (New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $dn))
}
...
function Remove-TemplateOidObject
{
    ...
    $searchRoot = New-Object System.DirectoryServices.DirectoryEntry (Get-LdapPath -DistinguishedName $containers.OidDN)
