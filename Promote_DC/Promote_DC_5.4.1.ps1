...
<img src="cid:$EmailLogoContentId" width="$EmailLogoWidth" height="$EmailLogoHeight" alt="DCUpgraderator" style="display:block;border:0;outline:none;text-decoration:none;" />
</div>
"@
}
