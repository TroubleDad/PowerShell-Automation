...
#
# Requirements: PowerShell 5.1; PSPKI module (Install-Module PSPKI);
...
function Initialize-PSPKI
{
    ...
    {
        throw ('Module [{0}] is not installed. Install it with: Install-Module {0} -Scope CurrentUser' -f $PSPKIModuleName)
    }
